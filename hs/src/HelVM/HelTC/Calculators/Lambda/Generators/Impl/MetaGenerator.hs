module HelVM.HelTC.Calculators.Lambda.Generators.Impl.MetaGenerator (
  generateCodeForIL,
...
generateCodeForAbsRe il f = "(lambda (" <> show il <> ")" <> generateCodeForLambda f <> ")" --FIXME Remove AbsRe
